namespace FunctionalLiving.Knx.Addressing
{
    using Exceptions;
    ...
    public class KnxTwoLevelGroupAddress : KnxGroupAddress
    {
        ...
        public KnxTwoLevelGroupAddress(string groupAddress) => InternalParse(groupAddress);

        public KnxTwoLevelGroupAddress(byte[] groupAddress) => InternalParse(groupAddress);
        ...
        public override string ToString() => $"{MainGroup}/{SubGroup}";

        public override bool Equals(object obj) => obj is KnxTwoLevelGroupAddress && base.Equals(obj);
