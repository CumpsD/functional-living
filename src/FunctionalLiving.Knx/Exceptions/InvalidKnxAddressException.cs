namespace FunctionalLiving.Knx.Exceptions
{
    ...
    public class InvalidKnxAddressException : Exception
    {
        ...
        public InvalidKnxAddressException(string address) => _address = address;
        ...
        /// </returns>
        public override string ToString() => $"InvalidKnxAddressException: Address {_address} is invalid.";
    }
}
