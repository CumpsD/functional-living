namespace FunctionalLiving.Knx
{
    ...
    public class KnxConnectionRouting : KnxConnection
    {
        ...
        /// </summary>
        public KnxConnectionRouting(ILoggerFactory loggerFactory)
            : this(loggerFactory, DefaultMulticastAddress, DefaultMulticastPort) { }
        ...
        public KnxConnectionRouting(ILoggerFactory loggerFactory, int port)
            : this(loggerFactory, DefaultMulticastAddress, port) { }
        ...
        public KnxConnectionRouting(ILoggerFactory loggerFactory, string host)
            : this(loggerFactory, host, DefaultMulticastPort) { }
        ...
        /// <param name="host">UDP multicast address to send/receive KNX messages</param>
        /// <param name="port">UDP port to send/receive KNX messages</param>
        public KnxConnectionRouting(ILoggerFactory loggerFactory, string host, int port)
            : base(loggerFactory, host, port)
        {
        ...
        public override void Connect()
        {
            ...
            KnxReceiver = new KnxReceiverRouting(_loggerFactory, this, _udpClients);
            KnxReceiver.Start();
