namespace FunctionalLiving.Knx.Log
{
    using System;
    ...
    public class Logger
    {
        ...
        internal static void Debug(string id, string message, params object[] arg) => DebugEventEndpoint(id, string.Format(message, arg));

        internal static void Info(string id, string message, params object[] arg) => InfoEventEndpoint(id, string.Format(message, arg));

        internal static void Warn(string id, string message, params object[] arg) => WarnEventEndpoint(id, string.Format(message, arg));

        internal static void Error(string id, string message, params object[] arg) => ErrorEventEndpoint(id, string.Format(message, arg));
